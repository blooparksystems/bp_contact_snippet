...
class contactus(http.Controller):
    ...
    @http.route(['/page/website.contactus', '/page/contactus'], type='http', auth="public",
                website=True)
    ...
    def create_lead(self, request, values, kwargs):
        ...
        return request.registry['crm.lead'].create(
            cr, SUPERUSER_ID, values, context=dict(context, mail_create_nosubscribe=True))
    ...
    def get_contactus_response(self, values, kwargs):
        ...
        return request.website.render(
            kwargs.get("view_callback", "bp_contact_snippet.contact_snippet_body_thanks"), values)
    ...
    def contactus(self, name, phone, description):
        ...
        for field_name, field_value in crm_data.items():
            ...
            elif field_name in request.registry['crm.lead']._fields and field_name not in \
                    _BLACKLIST:
